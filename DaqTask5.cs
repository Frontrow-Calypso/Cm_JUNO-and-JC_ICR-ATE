...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadDig1DU32", MxbFile="DaqTask5.mxb")]
    partial class DaqTask5Component : FiniteInputDaqComponent<DigitalMultiChannelReader, uint[]>
    {
        ...
        /// </summary>
        public DaqTask5Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                DaqTask5ComponentReadCompletedEventArgs args = new DaqTask5ComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(DaqTask5ComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<DaqTask5ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class DaqTask5ComponentReadCompletedEventArgs : ReadCompletedEventArgs<uint[]>
    {
        /// <summary>
        ...
        /// </param>
        public DaqTask5ComponentReadCompletedEventArgs(uint[] data)
            : base(data)
        {
        }
    }
    ...
    partial class DaqTask5Component
    {
        /// <summary>
        ...
        public event EventHandler<DaqTask5ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class DaqTask5ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public DaqTask5ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
