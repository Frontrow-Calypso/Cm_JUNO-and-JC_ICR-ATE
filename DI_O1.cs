...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Read1DBool", MxbFile="DI_O1.mxb")]
    partial class DI_O1Component : FiniteInputDaqComponent<DigitalMultiChannelReader, bool[]>
    {
        ...
        /// </summary>
        public DI_O1Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                DI_O1ComponentReadCompletedEventArgs args = new DI_O1ComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(DI_O1ComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<DI_O1ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class DI_O1ComponentReadCompletedEventArgs : ReadCompletedEventArgs<bool[]>
    {
        /// <summary>
        ...
        /// </param>
        public DI_O1ComponentReadCompletedEventArgs(bool[] data)
            : base(data)
        {
        }
    }
    ...
    partial class DI_O1Component
    {
        ...
        public event EventHandler<DI_O1ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class DI_O1ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public DI_O1ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
    ...
    public class DI_O1 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DIChannel ch = DIChannels.CreateChannel("Dev1/port1/line0", "DigitalIn_0", ChannelLineGrouping.OneChannelForEachLine);
                
                DIChannel ch2 = DIChannels.CreateChannel("Dev1/port1/line1", "DigitalIn_1", ChannelLineGrouping.OneChannelForEachLine);
