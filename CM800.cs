...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadWfm", MxbFile="CM800.mxb")]
    partial class CM800Component : FiniteInputDaqComponent<AnalogMultiChannelReader, AnalogWaveform<double>[]>
    {
        ...
        /// </summary>
        public CM800Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                CM800ComponentReadCompletedEventArgs args = new CM800ComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(CM800ComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<CM800ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class CM800ComponentReadCompletedEventArgs : ReadCompletedEventArgs<AnalogWaveform<double>[]>
    {
        /// <summary>
        ...
        /// </param>
        public CM800ComponentReadCompletedEventArgs(AnalogWaveform<double>[] data)
            : base(data)
        {
        }
    }
    ...
    partial class CM800Component
    {
        ...
        public event EventHandler<CM800ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class CM800ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public CM800ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
    ...
    public class CM800 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                AIChannels.CreateVoltageChannel("Dev1/ai3", "Voltage", AITerminalConfiguration.Differential, -3, 3, AIVoltageUnits.Volts);
                Timing.ConfigureSampleClock("", 5000, SampleClockActiveEdge.Rising, SampleQuantityMode.FiniteSamples, 100);
