...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="DaqTask2.mxb")]
    partial class DaqTask2Component : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
    ...
    partial class DaqTask2Component
    {
        ...
        public event EventHandler<DaqTask2ComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class DaqTask2ComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public DaqTask2ComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class DaqTask2 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DOChannel ch = DOChannels.CreateChannel("Dev1/port0/line7", "DigitalOut", ChannelLineGrouping.OneChannelForEachLine);
