...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadWfm", MxbFile="AI_1.mxb")]
    partial class AI_1Component : FiniteInputDaqComponent<AnalogMultiChannelReader, AnalogWaveform<double>[]>
    {
        ...
        /// </summary>
        public AI_1Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                AI_1ComponentReadCompletedEventArgs args = new AI_1ComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(AI_1ComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<AI_1ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class AI_1ComponentReadCompletedEventArgs : ReadCompletedEventArgs<AnalogWaveform<double>[]>
    {
        /// <summary>
        ...
        /// </param>
        public AI_1ComponentReadCompletedEventArgs(AnalogWaveform<double>[] data)
            : base(data)
        {
        }
    }
    ...
    partial class AI_1Component
    {
        ...
        public event EventHandler<AI_1ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class AI_1ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public AI_1ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
    ...
    public class AI_1 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                AIChannels.CreateVoltageChannel("Dev1/ai1", "Voltage", AITerminalConfiguration.Differential, -10, 10, AIVoltageUnits.Volts);
