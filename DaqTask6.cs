...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadWfm", MxbFile="DaqTask6.mxb")]
    partial class DaqTask6Component : FiniteInputDaqComponent<AnalogMultiChannelReader, AnalogWaveform<double>[]>
    {
        ...
        /// </summary>
        public DaqTask6Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                DaqTask6ComponentReadCompletedEventArgs args = new DaqTask6ComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(DaqTask6ComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<DaqTask6ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class DaqTask6ComponentReadCompletedEventArgs : ReadCompletedEventArgs<AnalogWaveform<double>[]>
    {
        /// <summary>
        ...
        /// </param>
        public DaqTask6ComponentReadCompletedEventArgs(AnalogWaveform<double>[] data)
            : base(data)
        {
        }
    }
    ...
    partial class DaqTask6Component
    {
        /// <summary>
        ...
        public event EventHandler<DaqTask6ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class DaqTask6ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public DaqTask6ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
    ...
    public class DaqTask6 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                AIChannels.CreateVoltageChannel("Dev1/ai6", "Voltage", AITerminalConfiguration.Rse, -10, 10, AIVoltageUnits.Volts);
