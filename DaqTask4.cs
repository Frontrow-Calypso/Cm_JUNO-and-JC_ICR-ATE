...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("ReadWfm", MxbFile="DaqTask4.mxb")]
    partial class DaqTask4Component : FiniteInputDaqComponent<AnalogMultiChannelReader, AnalogWaveform<double>[]>
    {
        ...
        /// </summary>
        public DaqTask4Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        protected override void EndReadFinite(IAsyncResult result)
        {
            try
            {
                ...
                DaqTask4ComponentReadCompletedEventArgs args = new DaqTask4ComponentReadCompletedEventArgs(data);
        ...
        /// </param>
        protected virtual void OnReadCompleted(DaqTask4ComponentReadCompletedEventArgs e)
        {
        ...
        public event EventHandler<DaqTask4ComponentReadCompletedEventArgs> ReadCompleted
        {
            add
            {
    ...
    /// </summary>
    public class DaqTask4ComponentReadCompletedEventArgs : ReadCompletedEventArgs<AnalogWaveform<double>[]>
    {
        /// <summary>
        ...
        /// </param>
        public DaqTask4ComponentReadCompletedEventArgs(AnalogWaveform<double>[] data)
            : base(data)
        {
        }
    }
    ...
    partial class DaqTask4Component
    {
        /// <summary>
        ...
        public event EventHandler<DaqTask4ComponentDataReadyEventArgs> DataReady
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class DaqTask4ComponentDataReadyEventArgs : DataReadyEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public DaqTask4ComponentDataReadyEventArgs(object data)
            : base(data)
        {
            throw new NotSupportedException("This member supports compatibility with code that is generated with a different timing mode and is not intended to be used directly from your code.");
        }
    ...
    public class DaqTask4 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                AIChannels.CreateVoltageChannel("Dev1/ai6", "Voltage", (AITerminalConfiguration)(-1), 0, 5, AIVoltageUnits.Volts);
                Timing.ConfigureSampleClock("", 20000, SampleClockActiveEdge.Rising, SampleQuantityMode.FiniteSamples, 50);
