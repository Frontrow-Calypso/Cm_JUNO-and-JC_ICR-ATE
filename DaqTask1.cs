...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("WriteDig1DU32", MxbFile="DaqTask1.mxb")]
    partial class DaqTask1Component : FiniteOutputDaqComponent<DigitalMultiChannelWriter, uint[]>
    {
        /// <summary>
    ...
    partial class DaqTask1Component
    {
        ...
        public event EventHandler<DaqTask1ComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class DaqTask1ComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public DaqTask1ComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
