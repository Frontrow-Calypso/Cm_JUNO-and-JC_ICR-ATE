...
namespace JC_ICR
{
    ...
    [ToolboxItem(false)]
    [TemplateData("Write1DBool", MxbFile="DaqTask3.mxb")]
    partial class DaqTask3Component : FiniteOutputDaqComponent<DigitalMultiChannelWriter, bool[]>
    {
        /// <summary>
        /// Initializes a new instance of the component.
        /// </summary>
        public DaqTask3Component()
        {
            Initialize();
        }
        ...
        /// </summary>
        public DaqTask3Component(IContainer container)
            : this()
        {
            if (container != null)
                container.Add(this);
        ...
        /// </param>
        protected override void WriteFinite(bool[] data)
        {
            Writer.WriteSingleSampleSingleLine(false, data);
        }
        ...
        /// requests.
        /// </param>
        protected override void BeginWriteFinite(bool[] data, AsyncCallback callback, object state)
        {
            Writer.BeginWriteSingleSampleSingleLine(false, data, callback, state);
        }
    ...
    partial class DaqTask3Component
    {
        /// <summary>
        ...
        public event EventHandler<DaqTask3ComponentGenerateDataEventArgs> GenerateData
        {
            add
            {
    ...
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public class DaqTask3ComponentGenerateDataEventArgs : GenerateDataEventArgs<object>
    {
        /// <summary>
        /// This member supports compatibility with code that is generated with a
        /// different timing mode and is not intended to be used directly from your code.
        /// </summary>
        public DaqTask3ComponentGenerateDataEventArgs(long numberOfChannelsToWrite)
    ...
    public class DaqTask3 : Task
    {
        ...
        public virtual void Configure()
        {
            ...
            // is regenerated.
                ...
                DOChannel ch = DOChannels.CreateChannel("Dev1/port0/line0", "DigitalOut_1", ChannelLineGrouping.OneChannelForEachLine);
